...
import 'package:tutor/Views/Auth/Login.dart';
...
class AuthController {
  ...
  Future<String?> userRegistration(data) async {
    return await _auth
      ...
      await _databaseRef.child(FirebaseStructure.USERS).child(uid).set(data);
      return uid;
    }).catchError((e) {
    ...
    await _databaseRef
      ...
      if (event.snapshot.value != null) {
        user = LoggedUser(
            ...
            gmobile: profileUserData['gmobile'] ?? '',
